...
import { selectCursosState, selectStateCursos } from 'src/app/core/cursos/state/cursos.selectors';
...
export class EditarDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private inscripcionesStore: Store<InscripcionState>
  ) {
  ...
  editar(): void{
    ...
    this.inscripcionesStore.dispatch(editarInscripcion({inscripcion: i}));
    this.dialogRef.close();
  }
